 ...
 private boolean validaCampo(JTextField t){
   ...
   private void estaVacio(JTextField t)throws ProyectoExcepcion{
    ...
    private void initComponents() {
        ...
        btnClean.setBackground(new java.awt.Color(251, 229, 218));
        btnClean.setFont(new java.awt.Font("Dubai", 1, 18)); // NOI18N
    ...
    private void tblUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuariosMouseClicked
        ...
        cmbPermisos.setSelectedItem(tblUsuarios.getModel().getValueAt(col, 1));
